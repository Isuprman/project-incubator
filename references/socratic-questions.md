# Stage 0 — Socratic Question Bank
...
- 你最近一次为了完成某件事而手工复制粘贴/重复劳动，是什么事？
- 如果只能消除日常里的一个烦恼，你会选哪个？

## Round 4–6: identify the beneficiary

- 当你说"有价值"，你希望它具体为谁解决什么样的问题？
- 在你认识或容易接触到的人里，谁最可能愿意试用这个方向的东西？
- 你自己是目标用户吗？（自己当用户是最快的启动方式）

## Round 7–8: find the sharp edge

- 你希望简历借这个项目向招聘方证明哪一项核心能力？（后端/AI 应用/全栈/数据）
- 哪一项是你目前最缺少、也最希望通过一个项目让面试官相信你已经具备的能力？
...
Do **not** proceed to Stage 1 until the user chooses.
